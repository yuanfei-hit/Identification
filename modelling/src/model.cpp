...
Model::Model(int id, string name, vector<PointCloudT::Ptr> raw, vector<PointCloudT::Ptr> slices, vector<PointCloudT::Ptr> keys, vector<pair<float, float> > spans, vector<int> trimmed_slice_index, float height)
{
    ...
    if (id == 1)
    {
    	this->texture.push_back(4762.636895); //mean of stiffness
    	this->texture.push_back( 521.152025);  //deviation of stiffness
    }
    else if(id == 2)
    {
    	this->texture.push_back(4958.124555); //mean of stiffness
    	this->texture.push_back( 451.831271);  //deviation of stiffness
    }
    else if(id == 3)
    {
        this->texture.push_back(4786.338693); //mean of stiffness
        this->texture.push_back( 387.481057);  //deviation of stiffness
    }
    else if(id == 4)
	{
		this->texture.push_back(4704.025475); //mean of stiffness
		this->texture.push_back( 571.392384);  //deviation of stiffness
	}
    else if(id == 5)
	{
		this->texture.push_back(4336.618697); //mean of stiffness
		this->texture.push_back( 374.747736);  //deviation of stiffness
	}
    else if(id == 6)
	{
		this->texture.push_back(2077.003648); //mean of stiffness
		this->texture.push_back( 103.921871);  //deviation of stiffness
	}
    else if(id == 7)
    {
        this->texture.push_back( 984.631375); //mean of stiffness
        this->texture.push_back(  77.937508);  //deviation of stiffness
    }
    else if(id == 8)
    {
        this->texture.push_back(3545.673355); //mean of stiffness
        this->texture.push_back( 437.731372);  //deviation of stiffness
    }
    else if(id == 9)
    {
        this->texture.push_back(1294.616290); //mean of stiffness
        this->texture.push_back( 161.603319);  //deviation of stiffness
    }
    this->id = id;
    this->name = name;
    float max = -65535;
